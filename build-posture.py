...
base = pathlib.Path("/home/bhanuharya/hermes-posture-public")
...
(base / "posture.html").write_text(html)
print(f"posture.html written: {len(html)//1024} KB, tables={body.count('<table>')}")
